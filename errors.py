...
class ProviderError(MovieBotError):
    """Errors from external providers (Perplexity, Apify, etc.)."""
...
def get_user_safe_message(error: MovieBotError) -> str:
    ...
    messages = {
        ...
        "transient_provider_error": "I'm having a brief moment of trouble reaching my movie databases. Please try one more time.",
        "degraded_service_error": "Part of my recommendation engine is offline right now, but I can still help with basic lookups.",
        "internal_error": "I hit an unexpected snag. Please try again or use /reset to start over.",
